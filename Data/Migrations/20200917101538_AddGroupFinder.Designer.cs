...
namespace Data.Migrations
{
    ...
    [Migration("20200917101538_AddGroupFinder")]
    partial class AddGroupFinder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Classes.Friend", b =>
                {
                    ...
                    b.HasKey("ReceiverId", "RequesterId");
            ...
            modelBuilder.Entity("Domain.Classes.Games.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Classes.Groups.GroupMember", b =>
                {
            ...
            modelBuilder.Entity("Domain.Classes.User", b =>
                {
                    ...
                    b.Property<DateTime>("TermsAndConditionsAccepted")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("Domain.Classes.UserGame", b =>
                {
                    ...
                    b.Property<bool>("ActivelyLooking")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("OwnsAllComponents")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("WillingToPlayWith")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Classes.Friend", b =>
                {
                    b.HasOne("Domain.Classes.User", "Receiver")
                        .WithMany("FriendOf")
            ...
            modelBuilder.Entity("Domain.Classes.Groups.GroupMember", b =>
                {
                    b.HasOne("Domain.Classes.Groups.Group", "Group")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Domain.Classes.UserGame", b =>
                {
                    b.HasOne("Domain.Classes.Games.Game", "Game")
                        .WithMany()
